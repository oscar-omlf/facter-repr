...
def run_zero_shot(
    ...
    """
    prediction_source = batch_loader if batch_loader is not None else df
...
def evaluate_zero_shot(
    ...
    if "ranked_mids" not in df:
        raise ValueError(
            "DataFrame must contain 'ranked_mids' column; call run_zero_shot first"
        )
